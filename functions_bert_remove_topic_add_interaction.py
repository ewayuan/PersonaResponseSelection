...
class cnnBlock(nn.Module):
    ...
    def forward(self, context_response_similarity_matrix, persona_response_similarity_matrix,\
        ...
        all_concat = torch.cat([context_response_V, persona_response_V, context_response_word_level_attn_simialrity_matrix_V, persona_response_word_level_attn_simialrity_matrix_V], dim=1)
