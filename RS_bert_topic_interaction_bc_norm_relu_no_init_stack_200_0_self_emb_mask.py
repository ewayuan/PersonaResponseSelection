...
from functions_bert_topic_interaction_bc_norm_relu_no_init_stack_200_0_self_emb_mask import *
...
def main(config, progress):
    ...
    model_path = "model_200"
    lda = LdaModel.load(datapath(model_path))
    common_dict = load_pickle("./TopicModelling/dialog_data_dic_200.p")
    ...
    if not test_mode:
        ...
        # #                               all_Uce_context size:  torch.Size([n, 200, 768]) all_UPct_context size:  torch.Size([n, 1, 200])
        # #                               all_Uce_response size:  torch.Size([n, 200, 768]) all_UPct_response size:  torch.Size([n, 1, 200])
        # #                               all_Uce_persona size:  torch.Size([n, 200, 768]) all_UPct_persona size:  torch.Size([n, 1, 200])
